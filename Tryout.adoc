...
In this tutorial we will build upon the four lessons of our https://www.raywenderlich.com/android/learn[Android and Kotlin for Beginners] and teach you a mindset that will you bring you on the path to becoming a great developer: improving user interfaces, modelling your domain logic, unit tests and user validation.

You have been hard at work learning Kotlin and Android. Your third app will bring you the social validation you deserve: you will be building a shared tips calculator that you can use when partying with your friends!
...
If you have not Android Studio installed already, https://developer.android.com/studio[download it from here^]
...
But, it looks a bit _ugly_, doesn't it?
...
AppTheme:: is the style of our app. This means that our `textSize` of `24sp` will be applied everywhere by default. 
...
The attributes `layout_margin{Start,End,Top,Bottom}` and `padding{Start,End,Top,Bottom}` allows to add the necessary steps. 
...
Run again the app. Update the price, or the tips or the number of people. Press `Compute`.
...
inline class:: This cool feature was introduced in Kotlin 1.3. It allows you to have a conveninent wrapper class without paying the price that would come with it.

Why do we define a Dollar class at all?:: This is the most interesting point here is.
...
There is a Java Money and Currency API that we could use. Because reinventing the wheel is bad, right? Well, not always. This API is a bit ugly and does 10 times more things than what we need. More importantly, we will learn lot of things in the process. Let's get started!
...
Next we want to do some computation wit `Tips`.
